  ...
  getPageConfig(): any {
    return {
      ...
      header: {
        ...
        paragraph: 'ברוכים הבאים לחברתנו, המציעה לכם את הפתרון המושלם לקמפיינים הממומנים שלכם בגוגל. אנו מתמחים בבניית עמודי נחיתה מהירים, מעוצבים ומותאמים אישית לקמפיין שלכם, ובניית קמפיין גוגל ממומן מקצועי שמייצר לידים במחיר תחרותי. אצלנו, אתם מקבלים את השילוב המנצח של טכנולוגיה, עיצוב ושיווק דיגיטלי.'
      },
      about: {
        title: 'מי אנחנו?',
        subtitle: 'קצת עלינו',
        paragraph: [
          ...
          'המשימה שלנו היא להפוך את הקמפיינים שלכם למוצלחים ויעילים ככל האפשר. אנחנו מאמינים בשילוב של טכנולוגיה, עיצוב ושיווק דיגיטלי כדי להביא לכם את התוצאות הטובות ביותר.',
